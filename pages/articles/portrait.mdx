...
Each of these *affective areas* will be discussed further in the following sections.
...
<Image src="/AOM.png" alt="Diagram of the Achievement Orientation Model" width={1428} height={620} style={{ margin: '1em auto' }} />

<span style={{ fontSize: "0.75em" }}>_Figure 1_. The Achievement Orientation Model (from [https://gifted.uconn.edu/aom/](https://gifted.uconn.edu/aom/))</span>
